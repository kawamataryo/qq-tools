...
export default {
    ...
    data () {
        return {
            ...
            { text: 'JCSI－１', value: '意識レベルJCSI－１' },
            { text: 'JCSI－２', value: '意識レベルJCSI－２' },
            { text: 'JCSI－３', value: '意識レベルJCSI－３' },
            { text: 'JCSⅡ－10', value: '意識レベルJCSⅡ－10' },
            { text: 'JCSⅡ－20', value: '意識レベルJCSⅡ－20' },
            { text: 'JCSⅡ－30', value: '意識レベルJCSⅡ－30' },
            { text: 'JCSⅢ－100', value: '意識レベルJCSⅢ－100' },
            { text: 'JCSⅢ－200', value: '意識レベルJCSⅢ－200' },
            { text: 'JCSⅢ－300', value: '意識レベルJCSⅢ－300' },
            ],
            pose: [
                '仰臥位',
                '右側臥位',
