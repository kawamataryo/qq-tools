<template>
    <section class="kotsuTab" id="kotsuTab">
        <!-- -------------------------------------------------------------------------------------------- -->
        <!-- フォーム -->
        <!-- -------------------------------------------------------------------------------------------- -->
        <form>
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <!-- 固定 -->
                    <div class="form-group row no-gutters">
                        <label class="col-3 col-form-label">固定の有無</label>
                        <div class="col-9">
                            <select class="form-control" v-model="fixedIn">
                                <option v-for="fi in fixed">{{ fi }}</option>
                            </select>
                        </div>
                    </div>
                    <!-- 酸素投与 -->
        ...
        <!-- 文章表示ボタン -->
        <hr>
        <button type="button" class="btn btn-primary btn-block mg-t-30" data-toggle="modal" data-target="#kotsuResult">文章作成</button>

        <!-- 結果表示モーダル -->
        <div class="modal fade" id="kotsuResult" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body" id="kotsuResltText">
                        準備中
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary clip_copy_btn" data-clipboard-target="#kotsuResltText">文章をコピー</button>
